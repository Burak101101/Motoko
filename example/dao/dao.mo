...
import Result "mo:base/Result"; //başarılı ise değişkende saklıyoz hata varsa err içinde saklarız
import Nat "mo:base/Nat"; //doğal sayılar
import Iter "mo:base/Iter"; //elemanların üzerinde doloşmak için trie içndeki döngü gibi
import Option "mo:base/Option"; //değer varsa some yoksa none olur
import Principal "mo:base/Principal"; //kullanıc veya canıster kimliğini saklar idleri yani
import Trie "mo:base/Trie"; //anahtar veri uyumuyla veri araması yapıyoz
import ICRaw "mo:base/ExperimentalInternetComputer"; //canister çağırmak için 
import Time "mo:base/Time";
import List "mo:base/List";
import Text "mo:base/Text";
import Types "./Types"; //typelar başka yerde
...
shared actor class DAO(init : Types.BasicDaoStableStorage) = Self {
  ...
  system func heartbeat() : async () { //timer belli aralıklarla işleme koyuyor 

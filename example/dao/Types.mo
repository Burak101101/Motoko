...
import Blob "mo:base/Blob"; //dosyları döüştürme
...
module {
    ...
    public type ProposalState = {
        #failed: Text; //main mo dakine göre aanca türü alttaikilerin
        #open;
        #executing;
        #rejected;
        #succeeded;
    ...
    public type UpdateSystemParamsPayload = {
        transfer_fee: ?Tokens; //bunlar ne olursa olsun eth falan okey
    ...
    public type SystemParams = {
        transfer_fee: Tokens; // bunlar ıcp sistem bura
        proposal_vote_threshold: Tokens;
        proposal_submission_deposit: Tokens; // bir kişi oyları domine edemesin
    };
